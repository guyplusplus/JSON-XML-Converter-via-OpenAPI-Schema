...
public class JSONSchemaForXML {
	...
	public JSONObject mapXMLToJSONObject(String inputXML) throws MapException {
	...
	public String mapXMLToJSONString(String inputXML, boolean formatOutput) throws MapException {
		XMLToJSONConverter converter = new XMLToJSONConverter(inputXML, (XMLNodeSpecObject)rootPropertyXMLNodeSpecObject.getXmlNodeSpec());
		converter.process();
		return jsonObjectToString(converter.getOutput(), formatOutput);
	}
	
	public Document mapJSONToXMLDocument(String inputJSON) throws MapException {
	...
	public String mapJSONToXMLString(String inputJSON, boolean formatOutput) throws MapException {
		JSONToXMLConverter converter = new JSONToXMLConverter(inputJSON, (XMLNodeSpecObject)rootPropertyXMLNodeSpecObject.getXmlNodeSpec());
		converter.process();
		return xmlDocumentToString(converter.getOutput(), formatOutput);
	}
	
	public static String jsonObjectToString(JSONObject o, boolean formatOutput) {
		return o.toString(formatOutput ? JSON_INDENT_SPACES : 0);
	}
	
	public static String xmlDocumentToString(Document inputDocument, boolean formatOutput) throws MapException {
		try {
